...
export const recordingApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    getAllRecordingByClassId: builder.query({
      query: (classId) => `/class/${classId}`,
      providesTags: (result, error, classId) =>
        result?.recordings
          ? [
              { type: "Recording", id: `CLASS-${classId}` },
              ...result.recordings.map((r) => ({
                type: "Recording",
                id: r._id,
              })),
    ...
    getRecordingByClassIdAndRecordingId: builder.query({
...
export const {
  ...
  useGetAllRecordingByClassIdQuery,
  useGetRecordingByClassIdAndRecordingIdQuery,
